...
class _HomePageState extends ModularState<HomePage, HomeController> {
  ...
  Widget _buildBody() {
    return (this.controller.currentIndex == 0) ? _buildBodyMundo() : _buildBodyPais();
  }
  ...
  Widget _buildBodyPais() {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          _buildHeader(
            controller.pais.pais,
            isPais: true,
            url: controller.pais.urlBandeira,
          ),
        ...
        builder: (context) {
          return AlertDialog(
            ...
            actions: [
              TextButton(
                onPressed: () {
                  this.controller.getInfoPais(nomePais: this.controller.textFieldController.text.toString());
                  Modular.to.pop();
                },
                child: Text(
                  "Ok",
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTile(
            ...
            trailing: Text(
              data,
              style: whiteText.copyWith(fontWeight: FontWeight.w300, fontSize: 30.0),
            ),
          ),
        ],
      ),
